    ...
    <div class="container">
            ...
            <ul>
                <li>
                    <a href="#" >
                        ...
                        <span class="title">LAB user </span>
                </li>
                <li>
        ...
        <script>
            ...
            function myFunction2() {
                document.getElementById("content").innerHTML = '<object type="text/html/php" style="height:100%; width:100%;" data="http://localhost:3000/html/homoeopathic/patient_process_lab.html"></object>';
            }
            
            document.getElementById("payment_status").onclick = function () { myFunction3() };
            function myFunction3() {
                document.getElementById("content").innerHTML = '<object type="text/html/php" style="height:100%; width:100%;" data="http://localhost:3000/html/homoeopathic/lab_man.html"></object>';
            }
