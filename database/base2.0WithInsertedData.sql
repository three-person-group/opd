...
INSERT INTO `homoeopathic_bill` (`billno`, `date`, `opdno`, `pname`, `reg_charge`, `medicine_name`, `medicine_qty`, `medicine_charges`, `medicine_total`, `other_name`, `other_qty`, `other_charges`, `other_total`, `test_name`, `test_qty`, `test_charges`, `test_total`, `total_charges`) VALUES
(1, '2022-03-24', 103, 'raj', 10, '', '', '', 0, '', '', '', 0, '', '', '', 0, 0),
(2, '2022-03-24', 104, 'alan', 0, '', '', '', 0, '', '', '', 0, '', '', '', 0, 0),
(3, '2022-03-24', 105, 'max', 10, '[\"1 WEEK DISPENSARY CHARGES\",\"BIO CHEMIC 1 WEEK\",\"MOTHER TINCHER 1 WEEK\"]', '[\"1\",\"1\",\"1\"]', '[\"20\",\"30\",\"40\"]', 90, '', '', '', 0, '', '', '', 0, 100),
(4, '2022-03-24', 106, 'xyz', 20, '[\"1 WEEK DISPENSARY CHARGES\",\"MOTHER TINCHER 1 WEEK\",\"MOTHER TINCHER 2 WEEK\"]', '[\"1\",\"1\",\"1\"]', '[\"10\",\"50\",\"0\"]', 60, '[\"MAJOR DRESSING(DEPENDS ON DRESSING)\",\"INJECTION\"]', '[\"1\",\"1\"]', '[\"0\",\"30\"]', 30, '[\"MALARIAL PARASITES - MP\",\"S.CALCIUM\",\"BLOOD GROUP\"]', '[\"1\",\"1\",\"1\"]', '[\"60\",\"80\",\"50\"]', 190, 300),
(5, '2022-03-25', 107, 'patel ashish r.', 0, '', '', '', 0, '[\"MAJOR DRESSING(DEPENDS ON DRESSING)\",\"MINOR DRESSING\",\"INJECTION\"]', '[\"1\",\"1\",\"1\"]', '[\"80\",\"10\",\"20\"]', 110, '', '', '', 0, 110);
...
--
ALTER TABLE `existing_patients`
  MODIFY `opdno` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT for table `homoeopathic_bill`
--
ALTER TABLE `homoeopathic_bill`
  MODIFY `billno` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `patient_register`
--
ALTER TABLE `patient_register`
  MODIFY `patientno` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
